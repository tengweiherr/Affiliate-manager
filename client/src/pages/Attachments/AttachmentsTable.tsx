    ...
    return (
        ...
        <tbody>
            {filteredAttachments.map((attachment:Attachment, index:number)=>(
                <tr key={index} className={`${attachment.referral}`} data-testid="attachmentsRow">
                    ...
                    <td className='action'>
                        <div className='m-auto'>
                            <button className='edit-icon' 
                                onClick={()=>{setSelectedAttachment(attachment);setAction("Edit");}}>
                                <EditIcon/>
                            </button>
                            <button className='trash-icon' 
                                onClick={()=>{setSelectedAttachment(attachment);setAction("Delete");}}>
                                <TrashIcon/>
                            </button>
                        </div>
                    </td>
